...
export function locationHeaderPlugin(url, response, previous) {
...
export const tall = (url, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (prev instanceof Follow) {
        return yield tall(prev.follow.toString(), Object.assign(Object.assign({}, options), { maxRedirects }));
    }
