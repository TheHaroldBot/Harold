...
module.exports = {
    ...
    async execute(interaction) { // inside here command stuff
        ...
        const serverInfoEmbed = new Discord.MessageEmbed()
            ...
            .setColor('RANDOM')
            .setThumbnail(targetGuild.iconURL({ dynamic: true, size: 512 }) || 'https://img.icons8.com/ios/500/shrug-emoticon.png')
            .setTimestamp();
    },
};